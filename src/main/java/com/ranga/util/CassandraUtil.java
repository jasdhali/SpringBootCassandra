...
public class CassandraUtil {
	...
	public CassandraClusterFactoryBean cluster() {
		...
		//cluster.setUsername("AWS_OR_DEV4_User");
		//cluster.setPassword("AWS_OR_DEV42016");
		...
		PlainTextAuthProvider sap = new PlainTextAuthProvider("AWS_OR_DEV4_User", "AWS_OR_DEV42016" );
	...
	public CassandraSessionFactoryBean session() throws Exception {
		...
		//cassandraSessionFactoryBean.set
